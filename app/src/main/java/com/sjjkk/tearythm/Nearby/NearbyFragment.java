package com.sjjkk.tearythm.Nearby;
...
public class NearbyFragment extends Fragment {
    ...
    private static final String HTML_LOCATION = "file:///android_asset/local.html";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        webView = (WebView) view.findViewById(R.id.nearby_webview);
